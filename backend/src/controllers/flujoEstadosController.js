...
import FlujoEstadosModel from "../models/flujoEstadosModel.js";

const baseController = new BaseController(FlujoEstadosModel, "Flujo estado");

class FlujoEstadosController {
...
export default FlujoEstadosController;
